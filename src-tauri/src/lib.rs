...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::scripts::get_profiles,
            commands::scripts::add_profile,
            commands::scripts::rename_profile,
            commands::scripts::remove_profile,
            commands::scripts::get_profile_scripts,
            commands::scripts::add_to_profile,
            commands::scripts::remove_from_profile,
            commands::scripts::set_script_disabled,
            commands::scripts::reorder_profile_scripts,
            commands::scripts::export_profile,
            commands::scripts::import_profile,
