...
CustomTweak  = { id, category, label, description, apply_cmd, revert_cmd: string, admin: boolean }  // sort_order exists as a DB column (ORDER BY sort_order) but isn't selected/returned — not actually part of this shape
